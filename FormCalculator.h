...
/// </summary>
public
ref class FormCalculator : public System::Windows::Forms::Form {
 public:
  FormCalculator(void) {
    InitializeComponent();
    //
 ...
 private:
  System::Windows::Forms::Label ^ labelSrcStr;

 protected:
 private:
  System::Windows::Forms::TextBox ^ textBoxSrcStr;

 private:
  System::Windows::Forms::TextBox ^ textBoxPolStr;

 protected:
 private:
  System::Windows::Forms::Label ^ labelPolStr;
 ...
 private:
  System::Windows::Forms::DataGridView ^ dataGridViewTableVar;

 private:
  System::Windows::Forms::Button ^ buttonCalculate;

 private:
  System::Windows::Forms::GroupBox ^ groupBoxWorkSpace;

 private:
  System::Windows::Forms::GroupBox ^ groupBoxTableVar;

 private:
  System::Windows::Forms::Button ^ buttonGenTable;
 ...
 private:
  System::Windows::Forms::ToolTip ^ toolTipButtonCreateTable;

 private:
  System::Windows::Forms::ToolTip ^ toolTipButtonCalculate;

 private:
  System::Windows::Forms::ToolTip ^ toolTipButtonClear;
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->toolTipButtonCreateTable =
        (gcnew System::Windows::Forms::ToolTip(this->components));
    this->toolTipButtonCalculate =
        (gcnew System::Windows::Forms::ToolTip(this->components));
    this->toolTipButtonClear =
        (gcnew System::Windows::Forms::ToolTip(this->components));
    (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(
         this->dataGridViewTableVar))
        ->BeginInit();
    ...
    this->labelSrcStr->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 15, System::Drawing::FontStyle::Regular,
    ...
    // textBoxSrcStr
    //
    this->textBoxSrcStr->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 10.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->textBoxSrcStr->TextChanged += gcnew System::EventHandler(
        this, &FormCalculator::textBoxSrcStr_TextChanged);
    //
    // textBoxPolStr
    //
    this->textBoxPolStr->Cursor = System::Windows::Forms::Cursors::No;
    this->textBoxPolStr->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 10.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->labelPolStr->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 15, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->textBoxResult->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 10.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->textBoxResult->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Center;
    //
    // labelResult
    //
    this->labelResult->AutoSize = true;
    this->labelResult->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 15, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->dataGridViewTableVar->BackgroundColor =
        System::Drawing::SystemColors::ControlLightLight;
    this->dataGridViewTableVar->ColumnHeadersHeightSizeMode = System::Windows::
    ...
    this->dataGridViewTableVar->ScrollBars =
    ...
    this->buttonCalculate->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 13.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->toolTipButtonCalculate->SetToolTip(
        this->buttonCalculate,
        L"The calculation of the entered expression will be performed");
    this->buttonCalculate->UseVisualStyleBackColor = true;
    this->buttonCalculate->Click += gcnew System::EventHandler(
        this, &FormCalculator::buttonCalculate_Click);
    //
    // groupBoxWorkSpace
    //
    ...
    this->groupBoxWorkSpace->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 10.2F, System::Drawing::FontStyle::Bold,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->buttonGenTable->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 13.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->toolTipButtonCreateTable->SetToolTip(
        this->buttonGenTable,
        L"After clicking, it will generate a table of variables and constants "
        L"of the entere"
        L"d expression");
    this->buttonGenTable->UseVisualStyleBackColor = true;
    this->buttonGenTable->Click +=
        gcnew System::EventHandler(this, &FormCalculator::buttonGenTable_Click);
    //
    // groupBoxTableVar
    //
    this->groupBoxTableVar->Controls->Add(this->dataGridViewTableVar);
    this->groupBoxTableVar->Enabled = false;
    this->groupBoxTableVar->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 9, System::Drawing::FontStyle::Bold,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->buttonClear->Font = (gcnew System::Drawing::Font(
        L"Tahoma", 13.8F, System::Drawing::FontStyle::Regular,
        System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
    ...
    this->toolTipButtonClear->SetToolTip(
        this->buttonClear, L"Returns the program to its start state");
    this->buttonClear->UseVisualStyleBackColor = true;
    this->buttonClear->Click +=
        gcnew System::EventHandler(this, &FormCalculator::buttonClear_Click);
    //
    // FormCalculator
    //
...
#pragma endregion
 ...
 private:
  System::Void textBoxSrcStr_TextChanged(System::Object ^ sender,
                                         System::EventArgs ^ e);

 private:
  System::Void buttonGenTable_Click(System::Object ^ sender,
                                    System::EventArgs ^ e);

 private:
  System::Void buttonCalculate_Click(System::Object ^ sender,
                                     System::EventArgs ^ e);

 private:
  System::Void buttonClear_Click(System::Object ^ sender,
                                 System::EventArgs ^ e);

 private:
  System::Void clearTable();

 private:
  System::Void clearPolStr();

 private:
  System::Void clearSrcStr();

 private:
  System::Void clearResult();
};
}  // namespace Calculator
